        ...
        coursePage.innerHTML = `
          ...
          <div class="panel-body"> 
            <ul class="nav">
              ...
              <li>
                <a href="javascript:loadmydiv('examinations/StudentMarkView')" id="EXM0011" class="btnItem" onclick="toggleButtonMenuItem()"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-dot-circle-o"></i>&nbsp;&nbsp;Marks</a>
              </li>
            </ul>
          </div>
        </div>
      </div></div></div>
    <p style="text-align: center;background-color: #297FB8">QUICK ACCESS</p>`;
